...
get_intron_coverages_per_chromosome <- function(chromosome, bed_graphs_data_fwd, bed_graphs_data_rev, intron_info, cl) { 
  ...
  # Split by chromosome
  coverage_data_fwd <- lapply(1:length(bed_graphs_data_fwd), get_intron_coverage_per_chromosome, chromosome, bed_graphs_data_fwd)        
  coverage_data_rev <- lapply(1:length(bed_graphs_data_rev), get_intron_coverage_per_chromosome, chromosome, bed_graphs_data_rev)
